...
const ProfilePage = ({ user, onLogout, onUpdateUser }) => {
  ...
  const handleDelete = async (postId) => {
    // ВСПЛЫВАЮЩЕЕ ОКНО ПОДТВЕРЖДЕНИЯ ДЛЯ ПОСТА
  ...
  // ФУНКЦИЯ УДАЛЕНИЯ КОММЕНТАРИЯ С ПОДТВЕРЖДЕНИЕМ И СВЯЗЬЮ С БД
                                ...
                                <div className="flex justify-between items-start mb-1">
                                  ...
                                  {(comment.username === user.username || post.username === user.username) && (
                                    <button
                                      ...
                                      className="text-gray-500 hover:text-red-500 font-bold transition-all p-1 text-[11px]"
